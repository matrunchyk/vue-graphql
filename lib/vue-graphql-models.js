...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: isDebug, version, isMobile, getGQLDocument, ucwords, lowerCaseFirst, humanBytes, sortBy, pick, defineProperties, getGQLDocumentName, httpPost, readFile, spawn, sleep, intersect, cloneDeep, stripTypename, findRecursive, findRouteMetas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getGQLDocument(loader, path) {
  ...
  if (isDebug()) {
    console.info("Passing loading process of ".concat(path, " to a loader...."));
  }

  return loader(path).catch(function () {
    if (isDebug()) {
      console.info("No GQL found using path ".concat(path, ". Skipping."));
    }
    ...
    if (isDebug()) {
      console.info("".concat(path, " has been imported successfully."));
    }
...
function spawn(constructor) {
  ...
  if (isDebug()) {
    console.info("Spawning a new instance of ".concat(constructor.name));
  }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                ...
                operation = this.vue.$apollo.mutate;
                _context4.prev = 12;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                operation = this.vue.$apollo.query;
                _context5.next = 11;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("Cache age: ".concat(diffSeconds, " seconds"));
                }
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("Inititated retrieval of ".concat(path, " from a cache..."));
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("\"".concat(propName, "\" is set to 'false', skipping."));
                }
              ...
              case 4:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("\"".concat(propName, "\" was not set, proceeding to an autoloading..."));
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("No cache found for ".concat(path, ", proceeding to a loader..."));
                }
              ...
              case 11:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  console.info("Caching \"".concat(propName, "\" for ").concat(path));
                }
