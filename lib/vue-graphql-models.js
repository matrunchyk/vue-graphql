...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: version, getApplication, isProd, isDev, isTest, isMobile, getEnv, getGQL, getGQLDocument, ucwords, lowerCaseFirst, humanBytes, sortBy, pick, defineProperties, getGQLDocumentName, httpPost, readFile, spawn, sleep, intersect, cloneDeep, findRecursive, findRouteMetas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getApplication() {
  return vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$application || {};
}
/**
...
function getGQL(path) {
  ...
  if (!application || !application.config | !application.config.graphqlPath) {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_1__["default"].ConfigurationException('Configuration error. Please ensure that "graphqlPath" is set.');
  }

  var graphqlPath = application.config.graphqlPath;
...
function () {
  ...
  function BaseModel() {
    ...
    this.init();
    this.application = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getApplication"])();
  } // Static getters
...
function () {
  function Field(_ref) {
    ...
    _defineProperty(this, "application", Object(_lib_utils__WEBPACK_IMPORTED_MODULE_1__["getApplication"])());
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return __webpack_require__("./src/models/Forms lazy recursive ^.*$")("".concat(this.application.config.dataPath, "/").concat(this.source));
...
function () {
  ...
  _createClass(Item, [{
    ...
    value: function getBoundProps() {
      ...
      var _getApplication = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_1__["getApplication"])(),
          vuex = _getApplication.config.vuex;
