...
var _BaseModel = _interopRequireDefault(__webpack_require__(/*! ./models/BaseModel.js */ "./src/models/BaseModel.js"));

var _exceptions = _interopRequireDefault(__webpack_require__(/*! ./models/exceptions */ "./src/models/exceptions/index.js"));

var _Collection = _interopRequireDefault(__webpack_require__(/*! ./models/Collection */ "./src/models/Collection.js"));

var _Repository = _interopRequireDefault(__webpack_require__(/*! ./models/Menu/repository/Repository */ "./src/models/Menu/repository/Repository.js"));

var _Item = _interopRequireDefault(__webpack_require__(/*! ./models/Menu/repository/Item */ "./src/models/Menu/repository/Item.js"));

var _Menu = _interopRequireDefault(__webpack_require__(/*! ./models/Menu */ "./src/models/Menu/index.js"));

var _Field = _interopRequireDefault(__webpack_require__(/*! ./models/Forms/Field */ "./src/models/Forms/Field.js"));

var _Form = _interopRequireDefault(__webpack_require__(/*! ./models/Forms/Form */ "./src/models/Forms/Form.js"));

var _Step = _interopRequireDefault(__webpack_require__(/*! ./models/Forms/Step */ "./src/models/Forms/Step.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Menu
// Forms
var _default = _BaseModel.default;
exports.default = _default;
...
exports.getGQL = getGQL;
exports.getGQLDocument = getGQLDocument;
...
exports.getGQLDocumentName = getGQLDocumentName;
...
exports.findRouteMetas = findRouteMetas;

var _InvalidArgumentException = _interopRequireDefault(__webpack_require__(/*! ../models/Exceptions/InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js"));

var _Application = _interopRequireDefault(__webpack_require__(/*! ../models/Application */ "./src/models/Application.js"));
...
function getGQL(path) {
  return __webpack_require__("./src/lib lazy recursive ^.*\\.graphql$")("".concat(_Application.default.config.graphqlPath, "/").concat(path, ".graphql"));
}
/* HTTP */
...
function intersect(one, two) {
  ...
  var intersection = new Set([].concat(_toConsumableArray(setA)).filter(function (s) {
    return setB.has(s);
  }));
...
function getGQLDocumentName(document) {
  ...
  if (!document.definitions || !Array.isArray(document.definitions) || !document.definitions.length) {
    throw new _InvalidArgumentException.default("Invalid GraphQL document specified.\n    Did you forget to add query or mutation to ".concat(callerClass, "?"));
  }
...
var _Config = _interopRequireDefault(__webpack_require__(/*! ./Config */ "./src/models/Config.js"));
...
function Application() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _Config.default();

  _classCallCheck(this, Application);

  _defineProperty(this, "config", new _Config.default());
...
var _toCase = _interopRequireDefault(__webpack_require__(/*! to-case */ "./node_modules/to-case/lib/index.js"));

var pluralize = _interopRequireWildcard(__webpack_require__(/*! pluralize */ "./node_modules/pluralize/pluralize.js"));

var _utils = __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");

var _Collection = _interopRequireDefault(__webpack_require__(/*! ./Collection */ "./src/models/Collection.js"));

var _Form = _interopRequireDefault(__webpack_require__(/*! ./Forms/Form */ "./src/models/Forms/Form.js"));

var _Application = _interopRequireDefault(__webpack_require__(/*! ./Application */ "./src/models/Application.js"));
...
function () {
  ...
  function BaseModel() {
    ...
    _defineProperty(this, "__typename", '');
    ...
    this.init();
    this.application = _Application.default;
  } // Static getters
  ...
  _createClass(BaseModel, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                opName = (0, _utils.getGQLDocumentName)(mutation, this.className); // Sets a loading flag on
              ...
              case 7:
                ...
                (0, _utils.defineProperties)(this, result.data[opName]);
                _context3.next = 14;
                break;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                opName = (0, _utils.getGQLDocumentName)(query, this.className);
              ...
              case 8:
                ...
                resCol = new _Collection.default(result);
              ...
              case 15:
                return _context4.abrupt("return", this.hydrate((0, _utils.cloneDeep)(result)));

              case 18:
                _context4.prev = 18;
                _context4.t0 = _context4["catch"](5);
                console.error(_context4.t0.message);
                return _context4.abrupt("return", wantsMany ? new _Collection.default([]) : this.hydrate({}));
    ...
    value: function subscribeToMore(queryName) {
      ...
      this.subscriptionsMany.forEach(function (sub) {
        ...
        var opSubName = (0, _utils.getGQLDocumentName)(normalizedSub.document, _this3.className);
        var subscription = Object.assign({
          document: normalizedSub.document,
          updateQuery: function updateQuery(previousResult, _ref7) {
            var result = _ref7.subscriptionData.data[opSubName];
            return _defineProperty({}, queryName, [].concat(_toConsumableArray(previousResult[queryName]), [result]));
          }
        }, normalizedSub);
                    ...
                    return regeneratorRuntime.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            entityNamePlural = (0, pluralize)(_this4.className); // noinspection JSUnresolvedFunction

                            entitiesFolder = _toCase.default.camel(entityNamePlural);
                            _context5.prev = 2;
                            ...
                            _context5.next = 6;
                            return (0, _utils.getGQLDocument)("".concat(entitiesFolder, "/queries/fetch").concat(_this4.className));
                          ...
                          case 7:
                            ...
                            _context5.next = 10;
                            return (0, _utils.getGQLDocument)("".concat(entitiesFolder, "/queries/fetch").concat(entityNamePlural));
                          ...
                          case 11:
                            ...
                            _context5.next = 14;
                            return (0, _utils.getGQLDocument)("".concat(entitiesFolder, "/mutations/update").concat(_this4.className));
                          ...
                          case 15:
                            ...
                            _context5.next = 18;
                            return (0, _utils.getGQLDocument)("".concat(entitiesFolder, "/mutations/create").concat(_this4.className));
    ...
    value: function prepareFieldsVariables() {
      ...
      inputFields.forEach(function (key) {
        ...
        if (inputFieldsVariables[key] instanceof _Collection.default) {
    ...
    get: function get() {
      return (0, _moment.default)(this.createdAt).fromNow();
    }
    /**
    ...
    get: function get() {
      return (0, _utils.pick)(this, this.inputFields);
    }
    /**
    ...
    get: function get() {
      ...
      return {
        name: _toCase.default.snake(this.className),
        params: {
          key: this._key
        },
        query: {
    ...
    get: function get() {
      if (!this.pForm) {
        this.pForm = new _Form.default(this);
      }
...
var _collect = _interopRequireDefault(__webpack_require__(/*! collect.js */ "./node_modules/collect.js/dist/index.js"));
...
function () {
  function Collection(items) {
    ...
    this.collection = (0, _collect.default)(items);
    return new Proxy(this, {
  ...
  _createClass(Collection, [{
    ...
    value: function sortExtendedBy() {
      ...
      return (0, _collect.default)((0, _utils.sortBy)(this.collection.all(), sortOpts));
    }
  }], [{
    key: "__get",
    value: function __get(target, prop) {
...
function (_Error) {
  ...
  function BaseException() {
    ...
    _this = _possibleConstructorReturn(this, (BaseException.__proto__ || Object.getPrototypeOf(BaseException)).call(this));
...
var _BaseException2 = _interopRequireDefault(__webpack_require__(/*! ./BaseException */ "./src/models/Exceptions/BaseException.js"));
...
function () {
  ...
  _createClass(Field, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return __webpack_require__("./src/models/Forms lazy recursive ^.*$")("".concat(_Application.default.config.dataPath, "/").concat(this.source));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2() {
        var _ref6, model, _ref7, collection;
...
var _Step = _interopRequireDefault(__webpack_require__(/*! ./Step */ "./src/models/Forms/Step.js"));
  ...
  function Form(context) {
    ...
    context.formOptions().then(function (_ref) {
      ...
      _this.steps = steps.map(function (option) {
        return new _Step.default(option);
      });
...
var _Field = _interopRequireDefault(__webpack_require__(/*! ./Field */ "./src/models/Forms/Field.js"));
...
function () {
  function Step(_ref) {
    ...
    this.fields = fields.map(function (field) {
      return new _Field.default(field);
    });
  }
  /**
   * Returns an empty collection of model items.
...
var _example = _interopRequireDefault(__webpack_require__(/*! ./repository/items/example */ "./src/models/Menu/repository/items/example.js"));
...
var Menu = new _Repository.default([].concat(_toConsumableArray(_example.default)));
var _default = Menu;
exports.default = _default;
module.exports = exports["default"];
...
var _eventBus = _interopRequireDefault(__webpack_require__(/*! Lib/eventBus */ "./src/Lib/eventBus.js"));
...
function () {
  ...
  _createClass(Item, [{
    ...
    value: function getBoundProps() {
      ...
      var vuex = _Application.default.config.vuex;
...
var _Item = _interopRequireDefault(__webpack_require__(/*! ../Item */ "./src/models/Menu/repository/Item.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = [new _Item.default({
  id: 'exampleItem1',
  title: 'Example 1',
...
var _BaseException = _interopRequireDefault(__webpack_require__(/*! ./BaseException */ "./src/models/exceptions/BaseException.js"));

var _InvalidArgumentException = _interopRequireDefault(__webpack_require__(/*! ./InvalidArgumentException */ "./src/models/exceptions/InvalidArgumentException.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = {
  BaseException: _BaseException.default,
  InvalidArgumentException: _InvalidArgumentException.default
};
exports.default = _default;
module.exports = exports["default"];
