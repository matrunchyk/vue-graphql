(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vue-graphql", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["vue-graphql"] = factory(require("vue"));
	else
		root["vue-graphql"] = factory(root["vue"]);
...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, repository, keywords, author, license, bugs, homepage, devDependencies, dependencies, bundlesize, scripts, publishConfig, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"vue-graphql\",\"version\":\"2.4.6\",\"description\":\"Universal library which helps to build OOP-driven GraphQL based models for Vue components. Influenced by Laravel Eloquent Models & Collections.\",\"main\":\"lib/vue-graphql.js\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/matrunchyk/vue-graphql.git\"},\"keywords\":[\"oop\",\"es6\",\"models\",\"vue\",\"universal\",\"umd\",\"commonjs\",\"webpack\",\"collections\",\"laravel\",\"eloquent\",\"graphql\"],\"author\":\"Serhii Matrunchyk\",\"license\":\"MIT\",\"bugs\":{\"url\":\"https://github.com/matrunchyk/vue-graphql/issues\"},\"homepage\":\"https://github.com/matrunchyk/vue-graphql\",\"devDependencies\":{\"@babel/cli\":\"^7.6.2\",\"@babel/core\":\"^7.6.2\",\"@babel/plugin-proposal-class-properties\":\"^7.5.5\",\"@babel/plugin-proposal-export-default-from\":\"^7.5.2\",\"@babel/plugin-proposal-object-rest-spread\":\"^7.6.2\",\"@babel/plugin-syntax-dynamic-import\":\"^7.2.0\",\"@babel/preset-env\":\"^7.6.2\",\"@babel/register\":\"^7.6.2\",\"babel-eslint\":\"^10.0.3\",\"babel-loader\":\"^8.0.6\",\"babel-plugin-add-module-exports\":\"^1.0.2\",\"babel-plugin-transform-runtime\":\"^6.23.0\",\"bundlesize\":\"^0.18.0\",\"chai\":\"^4.2.0\",\"chai-fetch-mock\":\"^2.0.0\",\"codecov\":\"^3.6.1\",\"collect.js\":\"^4.16.6\",\"danger\":\"^6.1.13\",\"eslint\":\"^5.16.0\",\"eslint-loader\":\"^2.2.1\",\"fetch-mock\":\"^7.3.9\",\"filereader\":\"^0.10.3\",\"istanbul\":\"^0.4.5\",\"jsdom\":\"^12.2.0\",\"jsdom-global\":\"^3.0.2\",\"lodash\":\"^4.17.15\",\"mocha\":\"^5.2.0\",\"nyc\":\"^13.3.0\",\"pluralize\":\"^7.0.0\",\"to-case\":\"^2.0.0\",\"uglifyjs-webpack-plugin\":\"^2.2.0\",\"vue\":\"^2.6.10\",\"webpack\":\"^4.41.0\",\"webpack-cli\":\"^3.3.9\",\"yargs\":\"^12.0.5\"},\"dependencies\":{\"idempotent-babel-polyfill\":\"^7.4.4\"},\"bundlesize\":[{\"name\":\"vue-graphql\",\"path\":\"./lib/vue-graphql.min.js\",\"maxSize\":\"40 kb\"}],\"scripts\":{\"build\":\"NODE_ENV=production webpack --env dev && webpack --env build\",\"dev\":\"webpack --progress --colors --watch --env dev\",\"test\":\"NODE_ENV=test nyc --reporter lcovonly --reporter=text --reporter=text-summary mocha && codecov\",\"test:watch\":\"mocha -w ./test/*.spec.js\",\"filesize\":\"npm run build && bundlesize\"},\"publishConfig\":{\"registry\":\"https://npm.pkg.github.com/\"}}");
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: default, VueGraphql, BaseModel, Exceptions, Collection, Utils */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_VueGraphql__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/VueGraphql */ "./src/lib/VueGraphql.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "VueGraphql", function() { return _lib_VueGraphql__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony default export */ __webpack_exports__["default"] = (_lib_VueGraphql__WEBPACK_IMPORTED_MODULE_0__["default"]);


/***/ }),

/***/ "./src/lib/VueGraphql.js":
/*!*******************************!*\
  !*** ./src/lib/VueGraphql.js ***!
  \*******************************/
...
/* harmony default export */ __webpack_exports__["default"] = (VueGraphql);
...
function ucwords(str) {
  return "".concat(str).replace(/^(.)|\s+(.)/g, $1 => $1.toUpperCase());
}
/**
...
function humanBytes(bytes) {
  ...
  return "".concat((bytes / 1024 ** e).toFixed(2), " ").concat(' KMGTP'.charAt(e), "B").replace('  ', ' ');
}
/* HTTP */
...
function findRouteMetas(route) {
  return route.matched.map(m => m.meta).reduce((accumulator, current) => Object.assign(accumulator, current), {});
}
/**
...
function pick(source = {}, selected = []) {
  return selected.reduce((obj, key) => source[key] ? _objectSpread({}, obj, {
    [key]: source[key]
  }) : obj, {});
}
/**
...
function pickModelVariables(source = {}, selection = []) {
  let normalizedSelection = selection; // If it's not an array (hopefully, it's an object)

  if (!Array.isArray(selection) && typeof selection === 'object') {
    normalizedSelection = Object.keys(selection).map(k => ({
      [k]: selection[k]
  ...
  return normalizedSelection.reduce((obj, variable) => {
    ...
    let normalizedKey = variable; // If it's a map
    ...
    return source[normalizedVariable] !== undefined ? _objectSpread({}, obj, {
      [normalizedKey]: source[normalizedVariable]
    }) : obj;
  }, {});
}
/**
...
/* harmony import */ var _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Exceptions/ServerResponseException */ "./src/models/Exceptions/ServerResponseException.js");
/* harmony import */ var _Collection__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Collection */ "./src/models/Collection.js");
/* harmony import */ var _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Exceptions/InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
class BaseModel {
  ...
  boot(params = {}) {
    this.uncountables.forEach(rule => pluralize__WEBPACK_IMPORTED_MODULE_2__["addUncountableRule"](rule));
  ...
  createRoute(prefix = '', multiple = false) {
    ...
    const name = multiple ? pluralize__WEBPACK_IMPORTED_MODULE_2__(this.className) : this.className;
    return {
  ...
  processAttributes() {
    Object.keys(this.attributes).forEach(attrName => {
      ...
      Object.defineProperty(this, "_".concat(attrName), {
        value,
        writable: false
      }); // Casting
      ...
      if (Array.isArray(Factory)) {
        if (!Array.isArray(value)) {
          throw new _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_7__["default"]("Attribute \"".concat(attrName, "\" has type Array, but class property doesn't."));
        }
  ...
  async update() {
    const prepared = _objectSpread({}, this.prepareVariables(this.getUpdateVariables));

    const variables = this.flattenVariables ? prepared : {
  ...
  async create() {
    const prepared = _objectSpread({}, this.prepareVariables(this.getCreateVariables));
  ...
  async save(mutation, variables = {}) {
    ...
    const opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(mutation, this.className); // Clears an error
  ...
  async fetch(query, variables = {}, wantsMany = false) {
    ...
    const opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(query, this.className); // Clears an error
    ...
    try {
      ...
      if (!wantsMany && Array.isArray(result)) {
        throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_5__["default"]('Was expected an object but received an array.');
      }

      if (wantsMany && !Array.isArray(result)) {
        throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_5__["default"]('Was expected an array but received an object.');
      }

      if (wantsMany || Array.isArray(result)) {
        const resCol = new _Collection__WEBPACK_IMPORTED_MODULE_6__["default"](result);
        const filtered = resCol.filter(s => s);
        return filtered.sortBy(this.defaultSortBy).map(i => this.hydrate(i));
      }

      return this.hydrate(_objectSpread({}, Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(result), {
        _result: result
      }));
    } catch (e) {
      this.setError(e);
  ...
  subscribeToMore(queryName) {
    ...
    this.subscriptionsMany.forEach(sub => {
      ...
      const normalizedSub = sub instanceof String ? {
        document: sub
      } : new Object(sub);
      ...
      const opSubName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(normalizedSub.document, this.className);
      const subscription = Object.assign({
        ...
        updateQuery(previousResult, {
          ...
          return {
            [queryName]: [...previousResult[queryName], result]
          };
        }
  ...
  async loadDocuments() {
    ...
    return new Promise(async (resolve, reject) => {
      const entityNamePlural = pluralize__WEBPACK_IMPORTED_MODULE_2__(this.className);
      const gqlSrc = to_case__WEBPACK_IMPORTED_MODULE_1___default.a.camel(entityNamePlural);

      try {
        await this.getCachedGql('query', "".concat(gqlSrc, "/queries/fetch").concat(this.className));
        await this.getCachedGql('queryMany', "".concat(gqlSrc, "/queries/fetch").concat(entityNamePlural));
        await this.getCachedGql('mutationCreate', "".concat(gqlSrc, "/mutations/create").concat(this.className));
        await this.getCachedGql('mutationUpdate', "".concat(gqlSrc, "/mutations/update").concat(this.className));
        await this.getCachedGql('mutationDelete', "".concat(gqlSrc, "/mutations/delete").concat(this.className));
        await this.getCachedGql('mutationAttach', "".concat(gqlSrc, "/mutations/attach").concat(this.className));
        await this.getCachedGql('mutationDetach', "".concat(gqlSrc, "/mutations/detach").concat(this.className));
  ...
  async getCachedGql(propName, path) {
    ...
    if (!this[propName] || !this[propName].definitions) {
      if (!gqlCache[path]) {
        gqlCache[path] = await Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocument"])(this.gqlLoader, path);
      }
...
class ConfigurationException extends _BaseException__WEBPACK_IMPORTED_MODULE_0__["default"] {}
...
class InvalidArgumentException extends _BaseException__WEBPACK_IMPORTED_MODULE_0__["default"] {}
...
class ServerErrorException extends _BaseException__WEBPACK_IMPORTED_MODULE_0__["default"] {}
...
module.exports = __webpack_require__(/*! /Users/serhii/code/vue-graphql/src/index.js */"./src/index.js");
...
//# sourceMappingURL=vue-graphql.js.map