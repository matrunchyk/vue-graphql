(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vue-graphql-models", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["vue-graphql-models"] = factory(require("vue"));
	else
		root["vue-graphql-models"] = factory(root["vue"]);
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: default, VueGraphqlModels, BaseModel, Exceptions, Collection, Utils */
...
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "Utils", function() { return _lib_utils__WEBPACK_IMPORTED_MODULE_4__; });
// Plugin
 // Base
...
/* harmony import */ var _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Exceptions/ConfigurationException */ "./src/models/Exceptions/ConfigurationException.js");
/* harmony import */ var _Exceptions_BaseException__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Exceptions/BaseException */ "./src/models/Exceptions/BaseException.js");
/* harmony import */ var _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Exceptions/ServerResponseException */ "./src/models/Exceptions/ServerResponseException.js");
/* harmony import */ var _Collection__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Collection */ "./src/models/Collection.js");
/* harmony import */ var _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Exceptions/InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
...
function () {
  ...
  function BaseModel() {
    ...
    _defineProperty(this, "_documentsLoaded", false);
    ...
    _defineProperty(this, "defaultSortBy", 'uuid');

    _defineProperty(this, "primaryKey", 'uuid');

    _defineProperty(this, "dataKey", '');
    ...
    _defineProperty(this, "flattenVariables", false);
  ...
  _createClass(BaseModel, [{
    ...
    value: function boot() {
      ...
      this.uncountables.forEach(function (rule) {
        return pluralize__WEBPACK_IMPORTED_MODULE_2__["addUncountableRule"](rule);
      });
    ...
    value: function validateRouter() {
      if (_typeof(this.vue) !== 'object') {
        throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_4__["default"]("Vue instance must be VueComponent.\n      Make sure that BaseModel.vue contains your local vue instance.");
      }

      if (_typeof(this.vue.$route) !== 'object') {
        throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_4__["default"]("It seems like vue-router is not installed.\n      Make sure that you have installed vue-router and configured.");
      }
    }
  }, {
    key: "createRoute",
    value: function createRoute() {
      ...
      var name = multiple ? pluralize__WEBPACK_IMPORTED_MODULE_2__(this.className) : this.className;
      return {
        name: to_case__WEBPACK_IMPORTED_MODULE_1___default.a.camel("".concat(prefix).concat(name)),
    ...
    value: function processAttributes() {
      var _this = this;

      Object.keys(this.attributes).forEach(function (attrName) {
        var origName = "_".concat(attrName);
        var AttrValue = _this.attributes[attrName];
        var origAttrValue = _this[attrName];
        ...
        Object.defineProperty(_this, origName, {
          value: AttrValue,
          writable: false
        }); // Casting
        ...
        if (Array.isArray(AttrValue)) {
          if (!Array.isArray(origAttrValue)) {
            throw new _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_8__["default"]("Attribute \"".concat(attrName, "\" has type Array, but class property doesn't."));
          }

          _this[attrName] = origAttrValue.map(function (el) {
            return new AttrValue(el).valueOf();
          });
        } else {
          _this[attrName] = new AttrValue(origAttrValue).valueOf();
        }
      });
    }
    /**
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3() {
        var prepared, variables;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                prepared = _objectSpread({}, this.prepareVariables(this.getUpdateVariables));
                variables = this.flattenVariables ? prepared : _defineProperty({}, this.inputDataKey, prepared);
                _context3.next = 4;
                return this.loadDocuments();

              case 4:
                return _context3.abrupt("return", this.save(this.mutationUpdate, variables));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                prepared = _objectSpread({}, this.prepareVariables(this.getCreateVariables));
                variables = this.flattenVariables ? prepared : _defineProperty({}, this.inputDataKey, prepared);
                _context4.next = 4;
                return this.loadDocuments();

              case 4:
                return _context4.abrupt("return", this.save(this.mutationCreate, variables));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 3:
                ...
                throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_4__["default"]("It seems like vue-apollo is not installed.\n      Make sure that you have installed vue-apollo and configured.");

              case 5:
                opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(mutation, this.className); // Clears an error
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(query, this.className); // Clears an error
              ...
              case 11:
                ...
                throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_6__["default"]('Was expected an object but received an array.');
              ...
              case 15:
                ...
                throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_6__["default"]('Was expected an array but received an object.');
              ...
              case 17:
                ...
                resCol = new _Collection__WEBPACK_IMPORTED_MODULE_7__["default"](result);
                filtered = resCol.filter(function (s) {
                  return s;
                });
                return _context8.abrupt("return", filtered.sortBy(this.defaultSortBy).map(function (i) {
                  return _this3.hydrate(i);
                }));

              case 21:
                return _context8.abrupt("return", this.hydrate(_objectSpread({}, Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(result), {
                  _result: result
                })));
              ...
              case 24:
                ...
                if (!(_context8.t0 instanceof _Exceptions_BaseException__WEBPACK_IMPORTED_MODULE_5__["default"])) {
                  _context8.next = 30;
                  break;
                }
              ...
              case 30:
                return _context8.abrupt("return", wantsMany ? new _Collection__WEBPACK_IMPORTED_MODULE_7__["default"]([]) : this.hydrate({}));
    ...
    value: function subscribeToMore(queryName) {
      ...
      this.subscriptionsMany.forEach(function (sub) {
        ...
        var opSubName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["getGQLDocumentName"])(normalizedSub.document, _this4.className);
        var subscription = Object.assign({
          document: normalizedSub.document,
          updateQuery: function updateQuery(previousResult, _ref5) {
            var result = _ref5.subscriptionData.data[opSubName];
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                return _context9.abrupt("return", this.save(this.mutationAttach, (_this$save2 = {}, _defineProperty(_this$save2, this.primaryKey, this[this.primaryKey]), _defineProperty(_this$save2, this.inputDataKey, m.map(function (m) {
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                return _context10.abrupt("return", this.save(this.mutationDetach, (_this$save3 = {}, _defineProperty(_this$save3, this.primaryKey, this[this.primaryKey]), _defineProperty(_this$save3, this.inputDataKey, m.map(function (m) {
                  return m[m.primaryKey];
                })), _this$save3)));
                    ...
                    return regeneratorRuntime.wrap(function _callee12$(_context12) {
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            entityNamePlural = pluralize__WEBPACK_IMPORTED_MODULE_2__(_this5.className);
    ...
    value: function prepareVariables(selection) {
      ...
      inputFields.forEach(function (key) {
        ...
        if (selection[key] instanceof _Collection__WEBPACK_IMPORTED_MODULE_7__["default"]) {
    ...
    key: "saved",
    value: function saved(_ref8, props) {
      var store = _ref8.store,
          query = _ref8.query,
          queryName = _ref8.queryName,
          variables = _ref8.variables;
      this._result = props;

      if (this.propagateChanges) {
        Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["defineProperties"])(this, props);
      }
    }
    /**
    ...
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["pickModelVariables"])(this, this.saveVariables);
    }
    /**
    ...
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_3__["pickModelVariables"])(this, this.updateVariables);
    }
    /**
    ...
    key: "inputDataKey",
    get: function get() {
      return this.dataKey || to_case__WEBPACK_IMPORTED_MODULE_1___default.a.camel(this.className);
    }
  }, {
    key: "raw",
    get: function get() {
    ...
    value: function emptyCollection() {
      return new _Collection__WEBPACK_IMPORTED_MODULE_7__["default"]();
    }
    /**
