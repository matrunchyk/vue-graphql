  ...
  _createClass(BaseModel, [{
    ...
    value: function subscribeToMore(queryName) {
      ...
      this.subscriptionsMany.forEach(function (sub) {
        ...
        var opSubName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocumentName"])(normalizedSub.document, _this3.className);
                    ...
                    return regeneratorRuntime.wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            entityNamePlural = pluralize__WEBPACK_IMPORTED_MODULE_3__(_this4.className);
                            gqlSrc = to_case__WEBPACK_IMPORTED_MODULE_2___default.a.camel(entityNamePlural);
                            _context5.prev = 2;
                            _context5.next = 5;
                            return _this4.getCachedGql('query', "".concat(gqlSrc, "/queries/fetch").concat(_this4.className));

                          case 5:
                            _context5.next = 7;
                            return _this4.getCachedGql('queryMany', "".concat(gqlSrc, "/queries/fetch").concat(entityNamePlural));

                          case 7:
                            _context5.next = 9;
                            return _this4.getCachedGql('mutationCreate', "".concat(gqlSrc, "/mutations/create").concat(_this4.className));

                          case 9:
                            _context5.next = 11;
                            return _this4.getCachedGql('mutationUpdate', "".concat(gqlSrc, "/mutations/update").concat(_this4.className));
