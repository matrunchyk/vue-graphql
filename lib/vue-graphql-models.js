...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, repository, keywords, author, license, bugs, homepage, devDependencies, dependencies, bundlesize, scripts, default */
/***/ (function(module) {

module.exports = {"name":"vue-graphql-models","version":"1.12.3","description":"Universal library which helps to build OOP-driven GraphQL based models for Vue components. Influenced by Laravel Eloquent Models & Collections.","main":"lib/vue-graphql-models.js","repository":{"type":"git","url":"https://github.com/digitalideastudio/vue-graphql-models.git"},"keywords":["oop","es6","models","vue","universal","umd","commonjs","webpack","collections","laravel","eloquent","graphql"],"author":"Serhii Matrunchyk","license":"MIT","bugs":{"url":"https://github.com/digitalideastudio/vue-graphql-models/issues"},"homepage":"https://github.com/digitalideastudio/vue-graphql-models","devDependencies":{"@babel/cli":"^7.1.5","@babel/core":"^7.1.6","@babel/plugin-proposal-class-properties":"^7.1.0","@babel/plugin-proposal-export-default-from":"^7.0.0","@babel/plugin-proposal-object-rest-spread":"^7.0.0","@babel/plugin-syntax-dynamic-import":"^7.0.0","@babel/preset-env":"^7.1.6","@babel/register":"^7.0.0","babel-eslint":"^10.0.1","babel-loader":"^8.0.0","babel-plugin-add-module-exports":"^1.0.0","babel-plugin-transform-runtime":"^6.23.0","bundlesize":"^0.17.0","chai":"^4.2.0","chai-fetch-mock":"^2.0.0","codecov":"^3.1.0","collect.js":"^4.0.28","danger":"^6.1.5","eslint":"^5.9.0","eslint-loader":"^2.1.1","fetch-mock":"^7.2.5","filereader":"^0.10.3","istanbul":"^0.4.5","jsdom":"^12.2.0","jsdom-global":"^3.0.2","lodash":"latest","mocha":"^5.2.0","moment":"^2.22.2","nyc":"^13.1.0","pluralize":"^7.0.0","to-case":"^2.0.0","uglifyjs-webpack-plugin":"^2.0.1","vue":"^2.5.17","webpack":"^4.26.0","webpack-cli":"^3.1.2","yargs":"^12.0.5"},"dependencies":{"idempotent-babel-polyfill":"^7.0.0"},"bundlesize":[{"name":"vue-graphql-models","path":"./lib/vue-graphql-models.min.js","maxSize":"46 kb"}],"scripts":{"build":"NODE_ENV=production webpack --env dev && webpack --env build","dev":"webpack --progress --colors --watch --env dev","test":"NODE_ENV=test nyc --reporter lcovonly --reporter=text --reporter=text-summary mocha && codecov","test:watch":"mocha -w ./test/*.spec.js","filesize":"npm run build && bundlesize"}};
...
var labelStyle = ['background: #DFC35E', 'color: white', 'padding: 2px 4px', 'border-radius: 3px', 'font-weight: bold'];
...
function () {
  ...
  _createClass(Logger, [{
    key: "log",
    value: function log() {
      var tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'debug';
      var getFormattingArgs = Logger.getStyling(tag);
      var loggerMaps = {
        error: console.error,
        warn: console.warn,
        info: console.info,
      ...
      var logger = loggerMaps[tag] || loggerMaps.success;

      for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        args[_key - 1] = arguments[_key];
      }

      logger.apply(this, ["".concat(label, "%c").concat(args.join(' '))].concat(_toConsumableArray(getFormattingArgs)));
    }
  }], [{
    key: "__get",
    value: function __get(target, prop) {
      var allowedMethods = Object.keys(bgColorMaps);
      var normalizedProp = prop === 'log' ? 'debug' : prop;
      ...
      if (allowedMethods.includes(normalizedProp)) {
        return function () {
          ...
          return target.log.apply(target, [normalizedProp].concat(args));
        };
      }
    ...
    key: "getStyling",
    value: function getStyling() {
      var tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'debug';
      var bgColor = bgColorMaps[tag] || bgColorMaps.debug;
      return [labelStyle.join(';'), "color: ".concat(bgColor, ";margin-left: 7px")];
    }
  }]);
    ...
    Vue.mixin({
      created: function created() {
        if (!Vue.prototype.$pluginInstalled) {
          _Logger__WEBPACK_IMPORTED_MODULE_3__["default"].info("Installed successfully. Version: ".concat(_models_BaseModel__WEBPACK_IMPORTED_MODULE_0__["default"].version));
...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: isDebug, version, isMobile, getGQLDocument, ucwords, lowerCaseFirst, humanBytes, sortBy, pick, pickModelVariables, defineProperties, getGQLDocumentName, httpPost, readFile, spawn, sleep, intersect, cloneDeep, stripTypename, findRecursive, findRouteMetas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pickModelVariables", function() { return pickModelVariables; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stripTypename", function() { return stripTypename; });
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "vue");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_Exceptions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/Exceptions */ "./src/models/Exceptions/index.js");
...
/* harmony import */ var _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/Exceptions/InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js");
/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Logger */ "./src/lib/Logger.js");
...
function isDebug() {
  return !!(vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions && vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions.debug);
}
/**
...
function version() {
  return _package__WEBPACK_IMPORTED_MODULE_2__.version;
}
/**
...
function getGQLDocument(loader, path) {
  ...
  if (isDebug()) {
    _Logger__WEBPACK_IMPORTED_MODULE_4__["default"].debug("Passing loading process of ".concat(path, " to a loader...."));
  }

  return loader(path).catch(function () {
    if (isDebug()) {
      _Logger__WEBPACK_IMPORTED_MODULE_4__["default"].warn("No GQL found using path ".concat(path, ". Skipping."));
    }
    ...
    if (isDebug() && doc.__fake === undefined) {
      _Logger__WEBPACK_IMPORTED_MODULE_4__["default"].info("".concat(path, " has been imported successfully."));
    }
...
function spawn(constructor) {
  ...
  if (isDebug()) {
    _Logger__WEBPACK_IMPORTED_MODULE_4__["default"].debug("Spawning a new instance of ".concat(constructor.name));
...
function pick() {
  ...
  return selected.reduce(function (obj, key) {
    return source[key] ? _objectSpread({}, obj, _defineProperty({}, key, source[key])) : obj;
  }, {});
}
/**
 * Picks selected items from the object
...
function pickModelVariables() {
  var source = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var selection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var normalizedSelection = selection; // If it's not an array (hopefully, it's an object)

  if (!Array.isArray(selection) && _typeof(selection) === 'object') {
    normalizedSelection = Object.keys(selection).map(function (k) {
      return _defineProperty({}, k, selection[k]);
    }); // If it's something else, than array or object, we won't deal with it
  } else if (!Array.isArray(selection)) {
    throw new _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_3__["default"]('Selection should be either array or object.');
  }

  return normalizedSelection.reduce(function (obj, variable) {
    var normalizedVariable = variable;
    var normalizedKey = variable; // If it's a map

    if (_typeof(variable) === 'object') {
      var keys = Object.keys(variable);

      if (keys.length !== 1) {
        throw new _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_3__["default"]('Variable mapping should be a string or an object with a single key');
      }
    ...
    return source[normalizedVariable] !== undefined ? _objectSpread({}, obj, _defineProperty({}, normalizedKey, source[normalizedVariable])) : obj;
  }, {});
}
/**
...
function getGQLDocumentName(document) {
  ...
  if (!document || !document.definitions || !Array.isArray(document.definitions) || !document.definitions.length) {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_1__["default"].InvalidArgumentException("Invalid GraphQL document specified.\n    Did you forget to add query or mutation to ".concat(callerClass, "?"));
  }
...
/* harmony import */ var to_case__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! to-case */ "./node_modules/to-case/lib/index.js");
/* harmony import */ var to_case__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(to_case__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _lib_Logger__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/Logger */ "./src/lib/Logger.js");
/* harmony import */ var _Collection__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Collection */ "./src/models/Collection.js");
/* harmony import */ var _Forms_Form__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Forms/Form */ "./src/models/Forms/Form.js");
/* harmony import */ var _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Exceptions/ConfigurationException */ "./src/models/Exceptions/ConfigurationException.js");
/* harmony import */ var _Exceptions_BaseException__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Exceptions/BaseException */ "./src/models/Exceptions/BaseException.js");
/* harmony import */ var _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Exceptions/ServerResponseException */ "./src/models/Exceptions/ServerResponseException.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
...
function () {
  ...
  function BaseModel() {
    ...
    _defineProperty(this, "__typename", 'BaseModel');
    ...
    _defineProperty(this, "mutationDelete", {});

    _defineProperty(this, "mutationAttach", {});

    _defineProperty(this, "mutationDetach", {});
    ...
    _defineProperty(this, "casts", {});

    _defineProperty(this, "initialState", {});

    _defineProperty(this, "isDirty", false);

    _defineProperty(this, "uncountables", []);

    _defineProperty(this, "propagateChanges", true);

    _defineProperty(this, "inputFields", []);

    _defineProperty(this, "saveVariables", []);

    _defineProperty(this, "updateVariables", []);

    if (vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions) {
      this.$vgmOptions = vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions;
    }
  ...
  _createClass(BaseModel, [{
    ...
    value: function boot() {
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      this.uncountables.forEach(function (rule) {
        return pluralize__WEBPACK_IMPORTED_MODULE_3__["addUncountableRule"](rule);
      });
      this.setDefaultTypename();
      Object.assign(this, this.defaults);
      var processedParams = this.processCasts(params);
      Object.assign(this, processedParams); // TODO: Probably needs to be async to free up the event loop
    ...
    key: "validateRouter",
    value: function validateRouter() {
      if (_typeof(this.vue) !== 'object') {
        throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_8__["default"]("Vue instance must be VueComponent.\n      Make sure that BaseModel.vue contains your local vue instance.");
      }

      if (_typeof(this.vue.$route) !== 'object') {
        throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_8__["default"]("It seems like vue-router is not installed.\n      Make sure that you have installed vue-router and configured.");
      }
    }
  }, {
    key: "createRoute",
    value: function createRoute() {
      ...
      var name = multiple ? pluralize__WEBPACK_IMPORTED_MODULE_3__(this.className) : this.className;
      return {
        name: to_case__WEBPACK_IMPORTED_MODULE_2___default.a.camel("".concat(prefix).concat(name)),
        params: _defineProperty({}, this.primaryKey, this[this.primaryKey]),
        query: {
          from: from
        }
      };
    ...
    key: "processCasts",
    value: function processCasts(params) {
      var _this = this;

      if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
        _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Processing casts...');
      }

      var casted = Object.assign({}, params);
      Object.keys(casted).forEach(function (key) {
        if (!_this.casts[key]) {
          return;
        }

        casted[key] = new _this.casts[key](casted[key]).valueOf();
      });
      return casted;
    }
    /**
    ...
    value: function revert() {
      var state = Object.assign(this, this.defaults, this.initialState);
      this.isDirty = false;
      return state;
    }
  }, {
    ...
    value: function gqlLoader(path) {
      if (typeof vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions.gqlLoader !== 'function') {
      ...
      return vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$vgmOptions.gqlLoader(path);
    }
    /**
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                variables = _args.length > 0 && _args[0] !== undefined ? _args[0] : {};

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".get" method executed');
                }
              ...
              case 4:
                return _context.abrupt("return", this.fetch(this.query, variables));
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                variables = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : {};
              ...
              case 4:
                return _context2.abrupt("return", this.fetch(this.queryMany, variables));
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                prepared = _objectSpread({}, this.prepareFieldsVariables(), this.prepareVariables(this.updateVariables));

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".update" method executed');
                }
              ...
              case 4:
                return _context3.abrupt("return", this.save(this.mutationUpdate, (_this$save = {}, _defineProperty(_this$save, this.primaryKey, this[this.primaryKey]), _defineProperty(_this$save, this.inputDataKey, prepared), _this$save)));
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                prepared = _objectSpread({}, this.prepareFieldsVariables(), this.prepareVariables(this.getCreateVariables));

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".create" method executed');
                }
              ...
              case 4:
                return _context4.abrupt("return", this.save(this.mutationCreate, _defineProperty({}, this.inputDataKey, prepared)));
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".delete" method executed');
                }
              ...
              case 3:
                return _context5.abrupt("return", this.save(this.mutationDelete, _defineProperty({}, this.primaryKey, this[this.primaryKey])));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(mutation) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".save" method executed');
                }
              ...
              case 4:
                ...
                throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_8__["default"]("It seems like vue-apollo is not installed.\n      Make sure that you have installed vue-apollo and configured.");

              case 6:
                opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocumentName"])(mutation, this.className); // Clears an error

                this.setError(); // Sets a loading flag on
                 ...
                 */
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Save: Performing Apollo mutation...');
                }
              ...
              case 14:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].success('Save: Apollo mutation status: OK');
                }
              ...
              case 17:
                ...
                this.setError(_context6.t0);
                this.failed(_context6.t0);
                throw _context6.t0;
    ...
    key: "fetchMany",
    value: function () {
      var _fetchMany = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _context7.abrupt("return", this.fetch(query, variables, true));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee8(query) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                wantsMany = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : false;
                subscribeToMore = this.subscribeToMore;
                opName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocumentName"])(query, this.className);

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".fetch" method executed');
                } // Clears an error
              ...
              case 12:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].success('Fetch: Apollo mutation status: OK');
                }
                ...
                throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_10__["default"]('Was expected an object but received an array.');
              ...
              case 18:
                ...
                throw new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_10__["default"]('Was expected an array but received an object.');
              ...
              case 20:
                ...
                resCol = new _Collection__WEBPACK_IMPORTED_MODULE_6__["default"](result);
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Fetch: hydrating a collection');
                }

                return _context8.abrupt("return", sorted.map(function (i) {
                  return _this3.hydrate(i);
                }));

              case 26:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Fetch: hydrating a single model');
                }

                return _context8.abrupt("return", this.hydrate(Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(result)));

              case 30:
                _context8.prev = 30;
                _context8.t0 = _context8["catch"](9);
                this.setError(_context8.t0);
                this.failed(_context8.t0);

                if (!(_context8.t0 instanceof _Exceptions_BaseException__WEBPACK_IMPORTED_MODULE_9__["default"])) {
                  _context8.next = 36;
                  break;
                }
              ...
              case 36:
                _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].error(_context8.t0.message);
                return _context8.abrupt("return", wantsMany ? new _Collection__WEBPACK_IMPORTED_MODULE_6__["default"]([]) : this.hydrate({}));
    ...
    value: function subscribeToMore(queryName) {
      ...
      this.subscriptionsMany.forEach(function (sub) {
        ...
        var opSubName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocumentName"])(normalizedSub.document, _this4.className);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee9(models) {
        var _this$save4;
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                m = Array.isArray(models) ? models : [models];

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".attach" method executed');
                }
              ...
              case 4:
                return _context9.abrupt("return", this.save(this.mutationAttach, (_this$save4 = {}, _defineProperty(_this$save4, this.primaryKey, this[this.primaryKey]), _defineProperty(_this$save4, this.inputDataKey, m.map(function (m) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee10(models) {
        var _this$save5;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".detach" method executed');
                }
              ...
              case 4:
                return _context10.abrupt("return", this.save(this.mutationDetach, (_this$save5 = {}, _defineProperty(_this$save5, this.primaryKey, this[this.primaryKey]), _defineProperty(_this$save5, this.inputDataKey, m.map(function (m) {
                  return m[m.primaryKey];
                })), _this$save5)));
    ...
    key: "refreshCacheAge",
    value: function refreshCacheAge() {
      return localStorage.setItem('apollo-cache-persist-age', "".concat(new Date().getTime()));
    }
  }, {
    key: "validateCache",
    value: function () {
      var _validateCache = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                diffSeconds = (new Date() - new Date(age)) / 1000;

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].info("Cache age: ".concat(diffSeconds, " seconds"));
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Purging cache...');
                }
                ...
                _context11.next = 10;
                return this.$vgmOptions.cachePersistor.purge();
      ...
      return function validateCache() {
        return _validateCache.apply(this, arguments);
      };
    }()
  }, {
    key: "init",
        ...
        return regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Loading documents...');
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Documents already have loaded, exiting.');
                }
                    ...
                    return regeneratorRuntime.wrap(function _callee12$(_context12) {
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            entityNamePlural = pluralize__WEBPACK_IMPORTED_MODULE_3__(_this5.className);
                            gqlSrc = to_case__WEBPACK_IMPORTED_MODULE_2___default.a.camel(entityNamePlural);
                            _context12.prev = 2;
                            _context12.next = 5;
                            return _this5.getCachedGql('query', "".concat(gqlSrc, "/queries/fetch").concat(_this5.className));

                          case 5:
                            _context12.next = 7;
                            return _this5.getCachedGql('queryMany', "".concat(gqlSrc, "/queries/fetch").concat(entityNamePlural));

                          case 7:
                            _context12.next = 9;
                            return _this5.getCachedGql('mutationCreate', "".concat(gqlSrc, "/mutations/create").concat(_this5.className));

                          case 9:
                            _context12.next = 11;
                            return _this5.getCachedGql('mutationUpdate', "".concat(gqlSrc, "/mutations/update").concat(_this5.className));

                          case 11:
                            _context12.next = 13;
                            return _this5.getCachedGql('mutationDelete', "".concat(gqlSrc, "/mutations/delete").concat(_this5.className));

                          case 13:
                            _context12.next = 15;
                            return _this5.getCachedGql('mutationAttach', "".concat(gqlSrc, "/mutations/attach").concat(_this5.className));

                          case 15:
                            _context12.next = 17;
                            return _this5.getCachedGql('mutationDetach', "".concat(gqlSrc, "/mutations/detach").concat(_this5.className));

                          case 17:
                            _this5.documentsLoaded = true;
                            resolve();
                            _context12.next = 24;
                            break;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee14(propName, path) {
        return regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug("Inititated retrieval of ".concat(path, " from a cache..."));
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug("\"".concat(propName, "\" is set to 'false', skipping."));
                }
              ...
              case 4:
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug("\"".concat(propName, "\" was not set, proceeding to an autoloading..."));
                }
                ...
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug("No cache found for ".concat(path, ", proceeding to a loader..."));
                }

                _context14.next = 10;
                return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocument"])(this.gqlLoader, path);

              case 10:
                gqlCache[path] = _context14.sent;

              case 11:
                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug("Caching \"".concat(propName, "\" for ").concat(path));
                }
      ...
      return function getCachedGql(_x8, _x9) {
    ...
    value: function prepareVariables(selection) {
      var inputFields = Object.keys(selection);
      var prepared = {};
      inputFields.forEach(function (key) {
        // if value is Collection
        if (selection[key] instanceof _Collection__WEBPACK_IMPORTED_MODULE_6__["default"]) {
          var collection = selection[key].all();
          ...
          Object.assign(prepared, _defineProperty({}, key, selection[key]._id)); // Object.assign(prepared, { [key]: selection[key]
          // .[selection[key].primaryKey] });
          // if value is Array of Objects
        } else if (Array.isArray(selection[key])) {
          var arrayOfvalues = selection[key];
        ...
        } else if (_typeof(selection[key]) === 'object' && selection[key]) {
          Object.assign(prepared, _defineProperty({}, key, selection[key]._id)); // if value is simple type
        } else {
          Object.assign(prepared, _defineProperty({}, key, selection[key]));
        }
      });
      return prepared;
    }
    ...
    key: "saved",
    value: function saved(_ref6, props) {
      var store = _ref6.store,
          query = _ref6.query,
          queryName = _ref6.queryName,
          variables = _ref6.variables;

      if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
        _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].info('Updated hook fired');
      }

      if (this.propagateChanges) {
        Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["defineProperties"])(this, props);
      }
    ...
    key: "failed",
    value: function failed(e) {
      this._result = null;

      if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
        _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].error('Operation failed: ', e.message);
      }
    }
    /**
    ...
    key: "updated",
    value: function updated(store, props) {}
  }, {
    key: "defaults",
    // Instance getters
    ...
    get: function get() {
      return moment__WEBPACK_IMPORTED_MODULE_1___default()(this.createdAt).fromNow();
    }
    /**
    ...
    get: function get() {
      return moment__WEBPACK_IMPORTED_MODULE_1___default()(this.createdAt).valueOf();
    }
    /**
    ...
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["pick"])(this, this.inputFields);
    }
    /**
    ...
    key: "getCreateVariables",
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["pickModelVariables"])(this, this.saveVariables);
    }
    /**
    ...
    key: "getUpdateVariables",
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["pickModelVariables"])(this, this.updateVariables);
    }
    /**
    ...
    get: function get() {
      if (Array.isArray(this._result)) {
        return new _Collection__WEBPACK_IMPORTED_MODULE_6__["default"](this._result);
      }

      if (this._result instanceof _Collection__WEBPACK_IMPORTED_MODULE_6__["default"]) {
        return this._result;
      }

      return new _Collection__WEBPACK_IMPORTED_MODULE_6__["default"]();
    }
    /**
     * Return Forms object
     *
    ...
    get: function get() {
      if (!this.pForm) {
        this.pForm = new _Forms_Form__WEBPACK_IMPORTED_MODULE_7__["default"](this);
      }
        ...
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                variables = _args15.length > 0 && _args15[0] !== undefined ? _args15[0] : {};
                instance = this.empty(false);

                if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
                  _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('".find" method executed');
                }
              ...
              case 5:
                return _context15.abrupt("return", instance.fetch(instance.query, variables));
        ...
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                variables = _args16.length > 0 && _args16[0] !== undefined ? _args16[0] : {};
                instance = this.empty(false);
              ...
              case 5:
                return _context16.abrupt("return", instance.fetchMany(instance.queryMany, variables));
    ...
    value: function emptyCollection() {
      if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
        _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Spawning an empty collection...');
      }
    ...
    value: function empty() {
      var boot = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

      if (Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["isDebug"])()) {
        _lib_Logger__WEBPACK_IMPORTED_MODULE_5__["default"].debug('Spawning an empty model...');
      } // noinspection JSValidateTypes


      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["spawn"])(this, [{
        boot: boot
      }]);
    }
  }, {
    key: "version",
    get: function get() {
      return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["version"])();
    }
    /**
...
/***/ "./src/models/Exceptions/ServerResponseException.js":
/*!**********************************************************!*\
  !*** ./src/models/Exceptions/ServerResponseException.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ServerErrorException; });
/* harmony import */ var _BaseException__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseException */ "./src/models/Exceptions/BaseException.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ServerErrorException =
/*#__PURE__*/
function (_BaseException) {
  _inherits(ServerErrorException, _BaseException);

  function ServerErrorException() {
    _classCallCheck(this, ServerErrorException);

    return _possibleConstructorReturn(this, _getPrototypeOf(ServerErrorException).apply(this, arguments));
  }
...
/* harmony import */ var _lib_Logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../lib/Logger */ "./src/lib/Logger.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
    ...
    value: function setOptions() {
      ...
      if (this.sourceType === 'json') {
        this.getOptionsFromFile().then(function (_ref2) {
          ...
          _lib_Logger__WEBPACK_IMPORTED_MODULE_3__["default"].error(err);
        });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                _lib_Logger__WEBPACK_IMPORTED_MODULE_3__["default"].error(_context.t0);
                this.setLoading(false);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 14:
                ...
                _lib_Logger__WEBPACK_IMPORTED_MODULE_3__["default"].error(_context2.t0);
                this.setLoading(false);
