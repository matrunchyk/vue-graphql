...
module.exports = {"name":"vue-graphql-models","version":"1.5.2","description":"Universal library which helps to build OOP-driven GraphQL based models for Vue components. Influenced by Laravel Eloquent Models & Collections.","main":"lib/vue-graphql-models.js","scripts":{"build":"webpack --env dev && webpack --env build && npm run test","dev":"webpack --progress --colors --watch --env dev","test":"mocha ./test/*.spec.js","test:watch":"mocha -w ./test/*.spec.js"},"repository":{"type":"git","url":"https://github.com/digitalideastudio/vue-graphql-models.git"},"keywords":["oop","es6","models","vue","universal","umd","commonjs","webpack","collections","laravel","eloquent","graphql"],"author":"Serhii Matrunchyk","license":"MIT","bugs":{"url":"https://github.com/digitalideastudio/vue-graphql-models/issues"},"homepage":"https://github.com/digitalideastudio/vue-graphql-models","devDependencies":{"@babel/cli":"^7.1.2","@babel/core":"^7.1.2","@babel/plugin-proposal-class-properties":"^7.1.0","@babel/plugin-proposal-export-default-from":"^7.0.0","@babel/plugin-proposal-object-rest-spread":"^7.0.0","@babel/plugin-syntax-dynamic-import":"^7.0.0","@babel/preset-env":"^7.1.0","@babel/register":"^7.0.0","babel-eslint":"^10.0.1","babel-loader":"^8.0.4","babel-plugin-add-module-exports":"^1.0.0","babel-polyfill":"^6.26.0","chai":"^4.2.0","collect.js":"^4.0.28","eslint":"^5.6.1","eslint-loader":"^2.1.1","istanbul":"^0.4.5","jsdom":"^12.2.0","jsdom-global":"^3.0.2","mocha":"^5.2.0","pluralize":"^7.0.0","to-case":"^2.0.0","uglifyjs-webpack-plugin":"^2.0.1","webpack":"^4.20.2","webpack-cli":"^3.1.2","yargs":"^12.0.2"},"dependencies":{"vue":"^2.5.17","moment":"^2.22.2"}};
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: default, BaseModel, Exceptions, Collection, Application, Config, MenuRepository, MenuItem, Menu, Field, Form, Step, Utils */
...
/* harmony import */ var _models_Menu_repository_MenuRepository__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/Menu/repository/MenuRepository */ "./src/models/Menu/repository/MenuRepository.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MenuRepository", function() { return _models_Menu_repository_MenuRepository__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _models_Menu_repository_MenuItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/Menu/repository/MenuItem */ "./src/models/Menu/repository/MenuItem.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MenuItem", function() { return _models_Menu_repository_MenuItem__WEBPACK_IMPORTED_MODULE_6__["default"]; });
...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: version, getApplication, getConfig, isMobile, getView, getGQL, getGQLDocument, ucwords, lowerCaseFirst, humanBytes, sortBy, pick, defineProperties, getGQLDocumentName, httpPost, readFile, spawn, sleep, intersect, cloneDeep, findRecursive, findRouteMetas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getConfig() {
  ...
  if (!application || !application.config) {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_1__["default"].ConfigurationException("Configuration error.\n    Please ensure that your application is configured.");
  }

  if (typeof application.config.gqlImporter !== 'function') {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_1__["default"].ConfigurationException('Configuration error. Please ensure that "gqlImporter" is set.');
  }
...
function getView(path) {
  var jsView = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var Config = function Config() {
  ...
  _defineProperty(this, "gqlImporter", function () {});

  _defineProperty(this, "dataImporter", function () {});

  _defineProperty(this, "modelImporter", function () {});

  _defineProperty(this, "viewImporter", function () {});
};
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_1__["getConfig"])().dataImporter(this.source);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_1__["getConfig"])().modelImporter(this.source);
