...
/*!**************************!*\
  !*** ./src/lib/utils.js ***!
  \**************************/
/*! exports provided: isDebug, version, sortBy, pick, pickModelVariables, defineProperties, getGQLDocumentName, spawn, intersect, cloneDeep, stripTypename, findRecursive, findRouteMetas */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/Exceptions/InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js");
...
function pickModelVariables(source = {}, selection = []) {
  ...
  if (!Array.isArray(selection) && typeof selection === 'object') {
    ...
    throw new _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_2__["default"]('Selection should be either array or object.');
  }
  ...
  return normalizedSelection.reduce((obj, variable) => {
    ...
    if (typeof variable === 'object') {
      ...
      if (keys.length !== 1) {
        throw new _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_2__["default"]('Variable mapping should be a string or an object with a single key');
      }
...
function getGQLDocumentName(document, callerClass = 'model class') {
  if (!document || !document.definitions || !Array.isArray(document.definitions) || !document.definitions.length) {
    throw new _models_Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_2__["default"]('Invalid GraphQL document specified.');
  }
...
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");
/* harmony import */ var _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Exceptions/ConfigurationException */ "./src/models/Exceptions/ConfigurationException.js");
...
class BaseModel {
  ...
  constructor(params = {}) {
    ...
    _defineProperty(this, "queryVariables", {});

    _defineProperty(this, "createVariables", []);
  ...
  get getCreateVariables() {
    return Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["pickModelVariables"])(this, this.createVariables);
  }
  /**
  ...
  get inputDataKey() {
    return this.dataKey || to_case__WEBPACK_IMPORTED_MODULE_2___default.a.camel(this.className);
  }
  ...
  boot(params = {}) {
    this.uncountables.forEach(rule => pluralize__WEBPACK_IMPORTED_MODULE_3__["addUncountableRule"](rule));
  ...
  validateRouter() {
    if (typeof this.vue !== 'object') {
      throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_5__["default"](`Vue instance must be VueComponent.
      Make sure that BaseModel.vue contains your local vue instance.`);
    }

    if (typeof this.vue.$route !== 'object') {
      throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_5__["default"](`It seems like vue-router is not installed.
  ...
  createRoute(prefix = '', multiple = false) {
    ...
    const name = multiple ? pluralize__WEBPACK_IMPORTED_MODULE_3__(this.className) : this.className;
    return {
      name: to_case__WEBPACK_IMPORTED_MODULE_2___default.a.camel(`${prefix}${name}`),
      params: {
  ...
  async save(mutation, variables = {}, opName) {
    ...
    if (typeof this.vue.$apollo !== 'object') {
      throw new _Exceptions_ConfigurationException__WEBPACK_IMPORTED_MODULE_5__["default"](`It seems like vue-apollo is not installed.
  ...
  async fetch(query, variables, wantsMany, opName) {
    ...
    try {
      ...
      if (!wantsMany && Array.isArray(result)) {
        const e = new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_6__["default"]('Was expected an object but received an array.');
        this.setError(e);
        this.failed(e);
        throw e;
      }
      ...
      if (wantsMany && !Array.isArray(result)) {
        const e = new _Exceptions_ServerResponseException__WEBPACK_IMPORTED_MODULE_6__["default"]('Was expected an array but received an object.');
        this.setError(e);
        this.failed(e);
        throw e;
      }
      ...
      return this.hydrate(_objectSpread({}, Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["cloneDeep"])(result), {
        _result: result
      }));
    } finally {
      this.setLoading(false);
  ...
  subscribeToMore(queryName) {
    ...
    this.subscriptionsMany.forEach(sub => {
      ...
      const opSubName = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__["getGQLDocumentName"])(normalizedSub.document, this.className);
  ...
  buildQuery(type, name, variables = null) {
    ...
    return graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a`${gqlString}`;
  }
