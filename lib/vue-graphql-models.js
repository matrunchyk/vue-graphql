    ...
    Object.keys(this.attributes).forEach(attrName => {
      ...
      if (Array.isArray(AttrValue)) {
        if (!Array.isArray(origAttrValue)) {
          throw new _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_7__["default"](`Attribute "${attrName}" has type Array, but class property doesn't.`);
        }
