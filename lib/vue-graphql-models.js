...
var VueGraphqlModels = {
  install: function install(Vue, options) {
    ...
    _models_Application__WEBPACK_IMPORTED_MODULE_0__["default"].configure(config);
    return _models_Application__WEBPACK_IMPORTED_MODULE_0__["default"];
  }
};
...
/* harmony import */ var _models_Application__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/Application */ "./src/models/Application.js");
...
function getApplication() {
  return _models_Application__WEBPACK_IMPORTED_MODULE_2__["default"];
}
/**
...
function getConfig() {
  ...
  if (!application || !application.config) {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_0__["default"].ConfigurationException("Configuration error.\n    Please ensure that your application is configured.");
  }

  if (typeof application.config.gqlImporter !== 'function') {
    throw new _models_Exceptions__WEBPACK_IMPORTED_MODULE_0__["default"].ConfigurationException('Configuration error. Please ensure that "gqlImporter" is set.');
  }
