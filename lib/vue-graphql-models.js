...
function pickModelVariables() {
  ...
  return normalizedSelection.reduce(function (obj, variable) {
    ...
    return source[normalizedVariable] ? _objectSpread({}, obj, _defineProperty({}, normalizedKey, source[normalizedVariable])) : obj;
  }, {});
}
/**
