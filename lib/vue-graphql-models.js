...
class BaseModel {
  ...
  createRoute(prefix = '', multiple = false) {
    ...
    return {
      name: to_case__WEBPACK_IMPORTED_MODULE_1___default.a.camel(`${prefix}${name}`),
      params: {
    ...
    Object.keys(this.attributes).forEach(attrName => {
      ...
      if (Array.isArray(AttrValue)) {
        if (!Array.isArray(origAttrValue)) {
          throw new _Exceptions_InvalidArgumentException__WEBPACK_IMPORTED_MODULE_8__["default"](`Attribute "${attrName}" has type Array, but class property doesn't.`);
        }
  ...
  async fetch(query, variables = {}, wantsMany = false) {
    ...
    try {
      ...
      if (wantsMany || Array.isArray(result)) {
        const resCol = new _Collection__WEBPACK_IMPORTED_MODULE_7__["default"](result);
      ...
      if (e instanceof _Exceptions_BaseException__WEBPACK_IMPORTED_MODULE_5__["default"]) {
        throw e;
      }

      return wantsMany ? new _Collection__WEBPACK_IMPORTED_MODULE_7__["default"]([]) : this.hydrate({});
    } finally {
      this.setLoading(false);
      this.finished();
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _InvalidArgumentException__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./InvalidArgumentException */ "./src/models/Exceptions/InvalidArgumentException.js");
/* harmony import */ var _ConfigurationException__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ConfigurationException */ "./src/models/Exceptions/ConfigurationException.js");
// import BaseException from './BaseException';


/* harmony default export */ __webpack_exports__["default"] = ({
  // BaseException,
  InvalidArgumentException: _InvalidArgumentException__WEBPACK_IMPORTED_MODULE_0__["default"],
  ConfigurationException: _ConfigurationException__WEBPACK_IMPORTED_MODULE_1__["default"]
});
